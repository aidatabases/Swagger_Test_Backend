  ...
  <div class="status-box">
    ...
    <div class="pro-content clearfix">
      ...
      <div class="pro-box">
        ...
        <small>Storage <unit-filter :format="'GB'" :show-default="true"></unit-filter></small>
      </div>
      <div class="pro-box">
        <radial-progress-bar :diameter="110"
                             :stroke-width="strokeWidth"
        ...
        <small>Memory <unit-filter :format="'GB'" :show-default="true"></unit-filter></small>
      </div>
    </div>
  </div>
</template>
...
export default {
  name: 'VirtualMachineCreateProjectLimits',
