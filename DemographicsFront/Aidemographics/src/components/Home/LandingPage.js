    ...
    <Slider className="slider-wrapper" autoplay={2000}>
      {content.map((item, index) => (
        ...
        >
          ...
          <button style={{width:'500px',height:'50px',backgroundColor:'black',color:'white',borderRadius:'80px',margin:'10px'}} onClick={()=>{window.location.href="http://covid.aidatabases.in/"}}>CovidDASHBOARD</button><br></br>
