...
useEffect(()=>{
    ...
    var toptext=svg.append("text").attr("x",20).attr("y",30)
   var states = svg.selectAll(".countries")
        ...
        var mState = states.append("path").attr("d",(d,i)=>{return geoPath().projection(projection)(d)})
                ...
                let vartxt=mstate+":"+data[statename][mstate][variable]
                toptext.text(vartxt)
                ...
                .on("mousemove", function(d){
                  ...
                  var dist = d.properties.district;  
                  var val="no data"
                  if(typeof(data[statename][dist])!=="undefined")
  ...
  return (
    ...
    <div>
      <svg className="mapsvg" width={ 500 } height={ 450 } style={{backgroundColor:"gray"}}>
